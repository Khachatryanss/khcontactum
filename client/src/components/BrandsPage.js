...
export default function BrandsPage({
  ...
  /* === ONE COLUMN MODE – GLASS ԿՈՆՏԵՅՆԵՐ === */
  if (cols === 1) {
    return h(
      "section",
      { className: "brands-public", style: { padding: "10px 12px" } },

      // Ամբողջ tapancik-ի շուրջը glass-morphism “քարտ”
      h(
        "div",
        {
          className: "brands-one-col-shell",
          style: {
            maxWidth: 620,
            margin: "0 auto",
        ...
        // Լույսի “բծեր”՝ ավելի premium տեսքի համար
        h("div", {
          style: {
            position: "absolute",
            inset: 0,
            ...
            background:
              ...
              "radial-gradient(circle at 100% 100%, rgba(255,255,255,0.20), transparent 55%)",
            opacity: 0.95,
          },
        }),

        // Իրական բովանդակություն՝ վերևում
        h(
          "div",
              ...
              return h(
                "div",
                {
                  ...
                  style: {
                    ...
                    // Փոքր glass քարտեր յուրաքանչուր brand-ի համար
