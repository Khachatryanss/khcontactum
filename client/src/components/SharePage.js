...
const TEXT = {
  ...
  ru: {
    ...
    mailApple: "Mail (iPhone по умолчанию)",
    mailMailApp: "Mail App",
    mailGmail: "Gmail",
  ...
  ar: {
    ...
    mailApple: "Mail (iPhone الافتراضي)",
    mailMailApp: "Mail App",
    mailGmail: "Gmail",
  ...
  fr: {
    ...
    mailApple: "Mail (iPhone par défaut)",
    mailMailApp: "Mail App",
    mailGmail: "Gmail",
...
function buildShareUrl(kind, url, text, mailSubject) {
  ...
  switch (kind) {
    ...
    case "mail":
      // mail-ը հիմա կառավարում ենք popup-ով
      return (
        "mailto:?subject=" +
